        ...
        <div id={styles.loginModal}>
          <div className={styles.modal}>
            <div className={styles.topForm}>
              <div onClick={showHidePopup} className={styles.closeModal}>
                &#10006;
              </div>
            </div>
    ...
    return (
      <>
        <div id={styles.loginModal}>
          <div className={styles.modal}>
            <div className={styles.topForm}>
              <div onClick={showHidePopup2} className={styles.closeModal}>
                &#10006;
              </div>
            </div>
            <div className={styles.loginForm}>
    ...
    return (
      <>
        <div id={styles.loginModal}>
          <div className={styles.modal}>
            <div className={styles.topForm}>
              <div onClick={showHidePopup3} className={styles.closeModal}>
                &#10006;
              </div>
            </div>
            <div className={styles.loginForm}>
