            ...
            <Container className="cont">
                ...
                <Navbar.Collapse id="responsive-navbar-nav" className="me">
                    <Nav className="me-auto">
                        <Nav.Link href="/featured" className="feature">Featured Jobs</Nav.Link>
                        <Nav.Link herf="# " > &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;</Nav.Link>
                        <Nav.Link href="/recomend" className="recommend">Recommended</Nav.Link>
                        <Nav.Link herf="# " > &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; </Nav.Link>
                        <Nav.Link href="/saved" className="saved">Saved</Nav.Link>
                        <Nav.Link herf="# " > &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; </Nav.Link>
