  ...
  return (
    <>
      <div id="formList2">
        ...
        <div className="arrow">
        <button onClick={PrevClick}><Icon icon="material-symbols:arrow-circle-left-sharp" className="ar" /></button>
        <button onClick={NextClick}><Icon icon="material-symbols:arrow-circle-right" className="ar" /></button>
    </div>
    </>
  );
    function  getcard(e) {
